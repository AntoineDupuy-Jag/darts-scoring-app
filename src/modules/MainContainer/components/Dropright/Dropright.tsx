		...
		<div className={styles.dropdown}>
			...
			<div className={styles.content}>
				<div className={styles.item}>
					...
					<a className={styles.itemLink} href="https://www.linkedin.com/in/antoine-dupuy-0a7a161a1/">
						{'LinkedIn'}
					</a>
				</div>
				<div className={styles.item}>
					<div className={classNames(styles.itemLogo, styles.gitHub)} />
					<a className={styles.itemLink} href="https://github.com/AntoineDupuy-Jag">
						{'GitHub'}
					</a>
				</div>
				<div className={styles.item}>
					<div className={classNames(styles.itemLogo, styles.contact)} />
					<a className={styles.itemLink} href="mailto:akabsn78@gmail.com">
						{'Contact'}
					</a>
				</div>
			</div>
